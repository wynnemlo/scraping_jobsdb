...
def create_dag(dag_id,
    ...
    def _scrape_job_urls(keyword: str, salaryMin: str, salaryMax: str, **kwargs):
        ...
        jobList = jobListContainer.find_all('a', 
            {'href': re.compile('\/hk\/en\/job.*')})
        for job in jobList:
            print(job['href'])
...
keywords = ['data-analyst', 'data-scientist', 'analytics-manager', 'data-engineer', 'data-governance', 'data-steward', 'data-management', 'machine-learning']
